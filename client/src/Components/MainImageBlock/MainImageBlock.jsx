...
const DropTarget = ({ onDrop }) => {
  ...
  return <div ref={drop} className="main__droparea"></div>;
};
...
const jackets = [
  {
    ...
    description:
      "Light, versatile synthetic insulated jacket works as a midlayer and standalone. Atom Series: Synthetic insulated midlayers.",
    price: "$340.00",
  ...
  },
  {
    ...
    description:
      "Full protection in a lightweight (LT), versatile, comfortable GORE-TEX shell. Beta Series: All round mountain apparel. | LT: Lightweight.",
    price: "$550.00",
...
const MainImageBlock = () => {
  ...
  return (
    <div className="container">
      <h1 className="container__title">Your calculated size: S</h1>
      <div className="main">
        ...
        <div className="main__center">
          ...
          {droppedItem && (
            <img className="main__img-selected" src={selectedProduct.image} />
          )}
